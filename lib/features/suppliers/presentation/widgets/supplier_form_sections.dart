                ...
                children: [
                  ...
                  Expanded(
                    child: TextFormField(
                      ...
                      decoration: InputDecoration(labelText: companyNameLabel),
                    ),
                  ),
                ],
              ),
...
class SupplierFormSectionCard extends StatelessWidget {
  const SupplierFormSectionCard({
    super.key,
    required this.title,
    required this.isDark,
